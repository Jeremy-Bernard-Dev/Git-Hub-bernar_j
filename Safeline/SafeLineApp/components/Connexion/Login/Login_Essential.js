...
export default function Login_Essential({ navigation }) {
    ...
    const _pressHandlerRegister = () => {
        navigation.navigate("Register_Essential");
    };
        ...
        <View style={styles.viewContainer}>
            ...
            <View style={styles.viewMiniContainer}>
                ...
                <View style={styles.viewFlexRow}>
                    <Text style={styles.textMiniText} onPress={_pressHandlerRegister}>Créer un compte essentiel</Text>
